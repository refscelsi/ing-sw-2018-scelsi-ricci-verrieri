...
public class NewPlayerFrom extends javax.swing.JFrame {
	...
	private View controller = new View();
	private static String network;

	public NewPlayerFrom() throws RemoteException {
		initComponents();
	...
	public static void main( String args[] ) {
		...
		try {
			...
			java.util.logging.Logger.getLogger( NewPlayerFrom.class.getName() ).log( java.util.logging.Level.SEVERE, null, ex );
		...
		java.awt.EventQueue.invokeLater( new Runnable() {
			public void run() {
				try {
					new NewPlayerFrom().setVisible( true );
