...
public class PlayerControllerController extends UnicastRemoteObject implements PlayerControllerInterfaceRMI, Remote {
    ...
    public PlayerControllerController(Match match, RemotePlayer remotePlayer, Player player) throws RemoteException {
        super();
        this.match = match;
    ...
    public void sendUseDiceRequest(int indexOfDiceInDraftPool, int row, int col) throws NetworkException, NotValidException, NotValidPlayException, RemoteException {
        ...
        switch (player.getState()) {
            ...
            case SCHEMETOCHOOSE:
                throw new NotValidPlayException("non puoi fare questa mossa ora");
            case USEDDICETOOLCARD:
                throw new NotValidPlayException("non puoi fare questa mossa ora");
            case FIRSTSTEPTOOLCARD:
                throw new NotValidPlayException("non puoi fare questa mossa ora");
