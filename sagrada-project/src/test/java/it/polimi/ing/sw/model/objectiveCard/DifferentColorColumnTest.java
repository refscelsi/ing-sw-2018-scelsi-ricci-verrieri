...
public class DifferentColorColumnTest {
    ...
    @Before
    public void before() {
        differentColorColumn = new DifferentColorColumn();
    ...
    public void executeTest() {
        ...
        score = differentColorColumn.calculateScore(scheme);
