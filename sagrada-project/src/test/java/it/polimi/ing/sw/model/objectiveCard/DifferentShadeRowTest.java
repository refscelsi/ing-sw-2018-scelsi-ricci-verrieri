...
public class DifferentShadeRowTest {

    private DifferentShadeRow differentShadeRow;
    ...
    @Before
    public void before() {
        differentShadeRow = new DifferentShadeRow();
        ...
        try {
            scheme.placeDice(1, 2, dice3);
        } catch (NotValidException e) {
            System.out.println(e.getMessage());
        }
        try {
            scheme.placeDice(1, 3, dice4);
        } catch (NotValidException e) {
            System.out.println(e.getMessage());
        }
        try {
            scheme.placeDice(1, 4, dice5);
        } catch (NotValidException e) {
            System.out.println(e.getMessage());
        }
        try {
            scheme.placeDice(2, 0, dice2);
        } catch (NotValidException e) {
            System.out.println(e.getMessage());
        }
        try {
            scheme.placeDice(2, 1, dice3);
        } catch (NotValidException e) {
            System.out.println(e.getMessage());
        }
        try {
        ...
        try {
            scheme.placeDice(2, 3, dice5);
        } catch (NotValidException e) {
            System.out.println(e.getMessage());
        }
        try {
            scheme.placeDice(2, 4, dice1);
        } catch (NotValidException e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    public void executeTest() {
        ...
        score = differentShadeRow.calculateScore(scheme);
