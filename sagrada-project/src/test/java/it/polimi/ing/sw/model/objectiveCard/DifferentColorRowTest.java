...
public class DifferentColorRowTest {
    ...
    @Before
    public void before() {
        differentColorRow = new DifferentColorRow();
    ...
    public void executeTest() {
        ...
        score = differentColorRow.calculateScore(scheme);
